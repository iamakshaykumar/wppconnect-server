...
const doc = {
  info: {
    version: '2.0.0',
    title: 'ePrincipal API Rest',
    description:
      'Welcome to the ePrincipal-server API documentation. This API provides a set of endpoints to interact with the ePrincipal-server application, allowing you to build integrations and automate interactions with WhatsApp.',
  },
